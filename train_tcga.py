...
def main():
    ...
    if args.dataset == 'TCGA-lung-default':
        ...
        #train_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_fold2.csv'
        #val_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_val_fold2.csv'
        #train_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_fold3.csv'
        #val_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_val_fold3.csv'
        #train_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_fold4.csv'
        #val_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_val_fold4.csv'
        train_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_fold5.csv'
        val_bags_csv = '/data/share_data/sjl_fl/tcga-dataset/TCGA_val_fold5.csv'
    else:
    ...
    train_path = pd.read_csv(train_bags_csv)
